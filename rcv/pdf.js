...
(async () => {
	...
	await page.pdf({
		...
		displayHeaderFooter: false, // Doesn't seem to work properly
	});
	...
	spawnSync( 'pdftk', [ 'body.pdf', 'background', 'footer.pdf', 'output', 'bodybg.pdf' ] );
	spawnSync( 'pdftk', [ 'first.pdf', 'bodybg.pdf', 'cat', 'output', 'david_tulloh.pdf' ] );
